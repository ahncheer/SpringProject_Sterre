...
<div id="container">
  ...
  <form class="form" name="frm" action="writeOk" method="post" onsubmit="return chkSubmit()">
    ...
    <div class="name">
      ...
      <input type="text" name="name" id="name_input" value="${user_id }" readonly>
    </div>
    
    <div class="telephone">
      <label for="name"></label>
      <input type="text" placeholder="제목 입력" name="subject" id="telephone_input">
    </div>
   
    <div class="message">
      <label for="message"></label>
      <textarea name="content" placeholder="내용 입력" id="message_input" cols="30" rows="5"></textarea>
    </div>
    
    <div class="submit" style="text-align: center; padding-bottom: 30px;">
      <input type="submit" value="글 등록" id="form_button" />
